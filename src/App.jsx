      ...
      <footer className="site-footer">
        <div className="footer-left">
          ...
          <div className="footer-socials">
            {/* Simple inline SVGs for perfectly clean social icons */}
